...
import 'package:SM1/model/model_taman/repositorytaman.dart';
import 'package:SM1/pages/detail_view.dart';
import 'package:google_nav_bar/google_nav_bar.dart';

class ListTaman extends StatefulWidget {
  const ListTaman({Key? key}) : super(key: key);

  @override
  State<ListTaman> createState() => _ListTamanState();
}

class _ListTamanState extends State<ListTaman> {
  List<Destinasi> listDestinasi = [];
  RepositoryTaman repository = RepositoryTaman();
  int _currentIndex = 0;
