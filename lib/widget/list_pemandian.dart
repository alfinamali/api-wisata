...
import 'package:SM1/model/model_pemandian/repositorypemandian.dart';
import 'package:SM1/pages/detail_view.dart';
import 'package:google_nav_bar/google_nav_bar.dart';

class ListPemandian extends StatefulWidget {
  const ListPemandian({Key? key}) : super(key: key);

  @override
  State<ListPemandian> createState() => _ListPemandianState();
}

class _ListPemandianState extends State<ListPemandian> {
  List<Destinasi> listDestinasi = [];
  RepositoryPemandian repository = RepositoryPemandian();
  int _currentIndex = 0;
